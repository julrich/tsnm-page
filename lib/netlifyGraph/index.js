...
const operationsDoc = `query SpotifyArtistCoverQuery($artistId: String = "") @netlify(id: """efb0708e-1295-49dd-ac34-d6ed954e9ac1""", doc: """Query to get cover image for an artist""") {
  spotify {
    artist(id: $artistId) {
      images {
        height
